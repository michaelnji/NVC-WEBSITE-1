      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <Card className="p-6">
          <div className="mb-2 text-xs text-muted-foreground">
            Créez ou modifiez un service. Les services sont utilisés pour lier
            les projets dans la section portfolio. Vous pouvez créer jusqu'à{" "}
            {MAX_SERVICES} services. Si la limite est atteinte, supprimez ou
