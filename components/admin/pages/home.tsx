...
export function AdminHomePage() {
  const [section, setSection] = useState<null | "hero" | "services" | "team" | "testimonials">(null)
    ...
    return (
      <div className="mt-2 sm:mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4">
        {[
          ...
          { key: "services", title: "Services & Projets", desc: "Cartes services et projets liés" },
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-[1.15rem] lg:text-[1.35rem] font-semibold tracking-tight leading-snug">
            {section === "hero" && "Hero"}
            {section === "services" && "Services & Projets"}
            {section === "team" && "Team"}
          ...
          <p className="text-[0.85rem] lg:text-sm text-muted-foreground mt-0.5">
            ...
            {section === "services" && "Gérez les services et projets associés."}
